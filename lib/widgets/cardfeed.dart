        ...
        child: Column( // WIDGET
          children: [
            ...
            SizedBox(
              ...
              height: 200,              // Altura fija (ajústala según lo que necesites)
              child: Image(
                // Selecciona dinámicamente el tipo de imagen según el contenido del campo "image".
                image: card["image"].toString().startsWith("http")
                    ? NetworkImage(card["image"]) // URL remota
                    : AssetImage("assets/image/${card["image"]}") as ImageProvider, // Imagen local

                fit: BoxFit.cover, // Ajusta la imagen para cubrir el espacio sin deformarse
              ),
            ), // ← COMA NECESARIA PARA SEPARAR HIJOS DEL COLUMN
